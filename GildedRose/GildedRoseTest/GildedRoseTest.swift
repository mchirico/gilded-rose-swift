...
//  GildedRoseTest
//
//  Created by Michael Chirico on 11/23/18.
//
...
class GildedRoseTest: XCTestCase {
  ...
  func testUpdateQuantityWithConjuredItem() {
    ...
    let expectedOutput = [Item(name: "Conjured Mana Cake", sellIn: 4, quality: 4)]
    let actualOutput = GildedRose.updateQuality(items: input)
  ...
  func testUpdateQuantityWithConjuredItemOnSellDate() {
    ...
    let expectedOutput = [Item(name: "Conjured Mana Cake", sellIn: -1, quality: 3)]
    let actualOutput = GildedRose.updateQuality(items: input)
  ...
  func testUpdateQuantityWithConjuredItemAfterSellDate() {
    ...
    let expectedOutput = [Item(name: "Conjured Mana Cake", sellIn: -2, quality: 3)]
    let actualOutput = GildedRose.updateQuality(items: input)
